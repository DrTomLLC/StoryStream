    ...
    pub fn from_format(format: AudioFormat) -> Self {
        match format {
            AudioFormat::Mp3 => MimeType {
                primary: "audio/mpeg",
                alternatives: vec!["audio/mp3"],
            },
            AudioFormat::Aac => MimeType {
                primary: "audio/aac",
                alternatives: vec![],
            },
            AudioFormat::M4a | AudioFormat::M4b => MimeType {
                primary: "audio/mp4",
                alternatives: vec!["audio/m4a", "audio/x-m4a"],
            },
            AudioFormat::Ogg => MimeType {
                primary: "audio/ogg",
                alternatives: vec!["audio/vorbis"],
            },
            ...
            AudioFormat::Wav => MimeType {
                primary: "audio/wav",
                alternatives: vec!["audio/x-wav", "audio/wave"],
            },
            AudioFormat::Aiff => MimeType {
                primary: "audio/aiff",
                alternatives: vec!["audio/x-aiff"],
            },
...
mod mime_tests {
    ...
    fn test_mime_type_mp3() {
        ...
        assert_eq!(mime.primary(), "audio/mpeg");
        assert!(mime.all().contains(&"audio/mp3"));
    }
